...
export default function Home() {
  ...
  const envelopeStyles = {
    ...
    topImage: {
      width: "calc(100% - 16px)",
      height: "auto",
      maxHeight: "clamp(200px, 42vh, 460px)",
      objectFit: "contain",
      objectPosition: "center",
      display: "block",
      margin: "clamp(4px, 0.8vh, 10px) auto clamp(2px, 0.5vh, 6px)",
      borderBottom: `2px solid ${COLORS.accentLight}`,
    },
    content: {
      flex: 1,
      padding: "0 clamp(12px, 4vw, 20px) clamp(12px, 2vh, 20px)",
      display: "flex",
      flexDirection: "column",
    ...
    clickText: {
      ...
      color: COLORS.textDark,
      opacity: 0.7,
      margin: "clamp(4px, 0.8vh, 10px) 0 clamp(4px, 0.8vh, 10px) 0",
